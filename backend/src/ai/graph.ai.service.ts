...
/**
 * if we use another model instead of gemini so we can use toolstragedy
 */
...
/**
 * when we need data from Ai a best format then firstly create Ai agent ..agent give me data proper formate
 * 
 */
...
const judge = createAgent({
        ...
        systemPrompt: `You are the judge tasked with evaluated the quality of two solutions generated by different Ai models. Please provide a score out of 10 for each solution, along with your reasoning for the scores.
    `
